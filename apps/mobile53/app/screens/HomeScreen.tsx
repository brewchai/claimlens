    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.card}>
                ...
                {showPreview && (
                    <VideoPreview title="Video Title" channel="Channel Name" isShort={isShortUrl(url)} />
                )}
                ...
                <View style={styles.buttonContainer}>
                    ...
                    >
                        <Text style={[styles.clearButtonText, !url && styles.clearButtonTextDisabled]}>Clear</Text>
                    </Pressable>
                </View>
            </View>
        </ScrollView>
